<!-- <div class="sidebar">
    <div class="logo">
        ...
        <ul class="menu">
            ...
            <li class="active">
                <a href="<?= base_url() ?>">
                    <i><img src="<?= media() ?>/icon/dashboard.png" alt="dashboard"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li>
                <a href="<?= base_url() ?>/Statistics/estadisticas">
            ...
            <li>
                <a href="<?= base_url() ?>/Servicios/servicios">
                    <i class="fa-solid fa-hand-holding"
                        style="color: #000; font-size: 20px; margin-left:5px; margin-bottom:10px;"></i>
                    <span>Servicios</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="equipos.php">
                    <i><img src="<?= media() ?>/icon/colaboracion.png" alt="equipos"></i>
                    <span>Equipos</span>
                </a>
            </li>
            <li>
                <a href="#">
                    <i><img src="<?= media() ?>/icon/informe.png" alt="informes"></i>
                    <span>Informes</span>
                </a>
            </li>
            <li>
                <a href="#">
                    <i><img src="<?= media() ?>/icon/ajustes.png" alt="ajustes"></i>
                    <span>Ajustes</span>
                </a>
            </li>
            <li class="logout">
                <a href="<?= base_url() ?>/Logout">
                    <i><img src="<?= media() ?>/icon/salir.png" alt="Cerrar Sesión"></i>
...
<div class="sidebar">
    <div class="logo">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="<?= base_url() ?>/Training/training">
                    <i class="fa-solid fa-arrow-trend-up" style="color: #000; font-size: 20px; margin-left:3px;"></i>
                    <span>Capacitación</span>
                </a>
            </li>
            <li>
